    ...
    <div className="max-w-3xl mx-auto">
      <div className="bg-white rounded-lg shadow-md p-8">
        ...
        <div className="prose max-w-none">
          <p>
            この利用規約（以下、「本規約」といいます。）は、Student Funding Platform（以下、「当社」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
          </p>
          ...
          <h2 className="text-xl font-semibold mt-6 mb-3">第6条（利用制限および登録抹消）</h2>
          <ol className="list-decimal pl-6 mt-2 mb-4">
          ...
          <h2 className="text-xl font-semibold mt-6 mb-3">第7条（退会）</h2>
          <p>ユーザーは、当社の定める退会手続により、本サービスから退会できるものとします。</p>
          
          <h2 className="text-xl font-semibold mt-6 mb-3">第8条（保証の否認および免責事項）</h2>
          <ol className="list-decimal pl-6 mt-2 mb-4">
          ...
          <h2 className="text-xl font-semibold mt-6 mb-3">第9条（サービス内容の変更等）</h2>
          <p>当社は、ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。</p>
          
          <h2 className="text-xl font-semibold mt-6 mb-3">第10条（利用規約の変更）</h2>
          <ol className="list-decimal pl-6 mt-2 mb-4">
          ...
          <h2 className="text-xl font-semibold mt-6 mb-3">第11条（個人情報の取扱い）</h2>
          <p>当社は、本サービスの利用によって取得する個人情報については、当社「プライバシーポリシー」に従い適切に取り扱うものとします。</p>
          
          <h2 className="text-xl font-semibold mt-6 mb-3">第12条（通知または連絡）</h2>
          ...
          <h2 className="text-xl font-semibold mt-6 mb-3">第13条（権利義務の譲渡の禁止）</h2>
          <p>ユーザーは、当社の書面による事前の承諾なく、利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し、または担保に供することはできません。</p>
          
          <h2 className="text-xl font-semibold mt-6 mb-3">第14条（準拠法・裁判管轄）</h2>
          <ol className="list-decimal pl-6 mt-2 mb-4">
